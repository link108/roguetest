...
def render_all(game_map, fov_map, fov_recompute):
...
while not libtcod.console_is_window_closed():
    ...
    render_all(game_map, fov_map, fov_recompute)
    ...
    player_action = Util.handle_keys(player, objects, game_state, game_map)
